...
InfoBubble.prototype.buildDom_ = function() {
  ...
  close.style['width'] = this.px(40);
  close.style['height'] = this.px(40);
  close.style['border'] = 0;
  close.style['zIndex'] = this.baseZIndex_ + 1;
  close.style['cursor'] = 'pointer';
  // close.src = 'http://maps.gstatic.com/intl/en_us/mapfiles/iw_close.gif';
  close.src = 'images/closeButton.png';
...
function submitAnswer(){
	...
	var uaxText = document.getElementById('uaxText').value;
	...
	var contextPath = document.getElementById("contextPath").value;
	var divRightAnswer = document.getElementById('divRightAnswer');
	var divCloseInstruction = document.getElementById('closeInstruction');
	var divTriviaSection = document.getElementById('triviaSection');
	...
	if( ax != "" ){
		    ...
		    if(uax == ax)
		    {
		    	rightAnswer = '<span style="font-size: 12px;color: green;font-weight: bold">Right Answer!</span>';
		    }else{
		    	rightAnswer = '<span style="font-size: 12px;color: red;font-weight: bold">Wrong! The right answer is ' + uax + ') ' + uaxText + '</span>';
		    }
		      
		    divRightAnswer.innerHTML = rightAnswer;
		    
		    divCloseInstruction.innerHTML = '<span style="font-size: 12px;color: blue;">Please click on the Close button to close this window. Your next location clue will be displayed below.</span>';
		    ...
		    if( locIndex == (locCount-1) )
		    {
				...
				divCloseInstruction.innerHTML = '<span style="font-size: 14px;color: blue;">Please click on the Close button to close this window.</span>';
				
		    }
		    
		    
		    //alert();
		    divTriviaSection.innerHTML = '<img style="float:left;" src="images/triviaSection/' + trailKey + '/' + trailKey + locIndex + '.jpg" >';
		    divTriviaSection.style.display = "block";
